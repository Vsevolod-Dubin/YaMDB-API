    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(db_index=True, help_text='Используйте формат для года <YYYY>', validators=[django.core.validators.MinValueValidator(1600), django.core.validators.MaxValueValidator(2025)], verbose_name='Год')),
